...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="jumbotron">
                <form action="register-model.php?id=<? echo $auto_id; php?>" method="POST">

                <div class="row">
                    <div class="form-group col-md-4 col-sm-4" style="margin-bottom:20px;">
                        <label for="exampleInputEmail1">Vehicle No:</label>
                        <input type="text" value="<?php echo $vehicle_no;?>" class=" form-control" name="vehicle_no" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>

                    <div class="form-group col-md-4 col-sm-4" style="margin-bottom:20px;">
                        <label for="exampleInputEmail1">Vehicle Owner Name:</label>
                        <input type="text" value="<?php echo $vehicle_owner;?>" class=" form-control" name="vehicle_owner" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
